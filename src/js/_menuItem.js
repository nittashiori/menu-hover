...
import { map, lerp, clamp, getMousePos } from './_utils';
const imageAll = document.querySelectorAll('.js-image');
const imageLength = imageAll.length;
const imageArray = [];
for (let i = 0; i < imageLength; i++) {
    imageArray.push(imageAll[i].dataset.img);
}
const images = Object.entries(imageArray);
